!function () {
	...
	let s = document.getElementById("user"), a = document.getElementById("email"), n = document.getElementById("password"),
		r = document.getElementById("password2"), p=document.getElementById("password");
