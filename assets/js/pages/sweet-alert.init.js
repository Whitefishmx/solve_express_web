function executeExample(e) {
	switch (e) {
		...
		case"handleDismiss":
			let t = Swal.mixin({customClass: {confirmButton: "btn btn-success", cancelButton: "btn btn-danger me-2"}, buttonsStyling: !1});
			return void t.fire({
				title: "Are you sure?",
				text: "You won't be able to revert this!",
				icon: "warning",
				...
				e.isConfirmed ? t.fire("Deleted!", "Your file has been deleted.", "success") : e.dismiss === Swal.DismissReason.cancel && t.fire("Cancelled", "Your imaginary file is safe :)", "error");
			});
		case"customImage":
			return void Swal.fire({
				title: "Rizz!",
		...
		case"timer":
			let e;
			return void Swal.fire({
				title: "Auto close alert!", html: "I will close in <b></b> milliseconds.", timer: 2e3, timerProgressBar: !0, didOpen: () => {
		...
		case"chainingModals":
			return void Swal.mixin({
				...
				showCancelButton: !0,
				progressSteps: ["1", "2", "3"]
			}).queue([{title: "Question 1", text: "Chaining swal2 modals is easy"}, "Question 2", "Question 3"]).then(e => {
		...
		case"mixin":
			return void Swal.mixin({
				toast: !0, position: "top-end", showConfirmButton: !1, timer: 3e3, timerProgressBar: !0, didOpen: e => {
