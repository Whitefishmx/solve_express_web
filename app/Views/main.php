<div class="card">
	<div class="card-body pt-0">
		<ul class="nav nav-pills nav-justified" role="tablist">
			...
			<li class="nav-item waves-effect waves-light" role="presentation">
				<a
						class="nav-link" data-bs-toggle="tab" href="#test2" role="tab" aria-selected="false" tabindex="-1" onclick="GetDisposiciones()">Disposiciones</a>
			</li>
			<li class="nav-item waves-effect waves-light" role="presentation">
...
<!--modal-->
<div
		class="modal fade" id="exampleModalScrollable" tabindex="-1" aria-labelledby="exampleModalScrollableTitle" style="display: none;" aria-modal="true"
		role="dialog">
